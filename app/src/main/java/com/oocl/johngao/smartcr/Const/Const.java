package com.oocl.johngao.smartcr.Const;
...
public class Const {
    ...
    public static final String NullConNo = "000";
    public static final String NullTCode = "00";

    public static final boolean NeedWash = true;
    public static final boolean IgnoreWash = false;
    public static final boolean WaitWash = false;
